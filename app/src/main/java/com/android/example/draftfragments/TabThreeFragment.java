...
public class TabThreeFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        textItems.add(new TextItem("First Text | Tab Three | Item One", "Second Text | Tab Three | Item One",
                R.drawable.placeholder));
        textItems.add(new TextItem("First Text | Tab Three | Item Two", "Second Text | Tab Three | Item Two",
                R.drawable.placeholder));
